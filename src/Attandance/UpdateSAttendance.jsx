...
export default function UpdateSAttendance() {
    ...
    function submitAttendance() {
      ...
      Promise.all(attendanceRecord.map((record) =>
        axios.put("http://localhost:5099/api/S_Attendance/UpdateStudentAttendance", record)
      ))
      .then((responses) => {
    ...
    <div className='main-content position-relative max-height-vh-100 h-100 border-radius-lg'>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td colSpan={2}>
              <button onClick={submitAttendance}>Update Attendance</button>
            </td>
          </tr>
        </tbody>
      </table>
